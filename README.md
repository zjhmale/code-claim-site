...
4. `yarn execute rinkeby scripts/setVesting`
5. `cd packages/hardhat && npx hardhat --network rinkeby etherscan-verify --api-key <etherscan API key>`
6. `yarn execute rinkeby scripts/merkleRootSanityCheck`
